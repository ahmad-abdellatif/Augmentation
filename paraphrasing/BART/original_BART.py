...
from scripts.paraphrasing.BART.data.utils import load_data, load_sof_data, clean_unnecessary_spaces
...
# Stack Overflow
# sof_df = load_sof_data("data/sof_duplicate_post.csv","Title", 'one_duplicate' ,'is_duplicate')
# s_train, s_test = train_test_split(sof_df)
# train_df = pd.concat([train_df, s_train])
# eval_df = pd.concat([eval_df, s_test])
